...
new #[Title('Daftarkan Wajah')] class extends Component
{
    ...
    public function save()
    {
        ...
        $this->loadFace();
        session()->flash('success', 'Registrasi wajah berhasil disimpan');
    }
    ...
    <div class="fixed inset-0 flex items-center justify-center p-2">
        <div class="bg-white w-full max-w-md rounded-2xl shadow-md">
            ...
            @if (session()->has('success'))
                <div class="mx-2 mb-3 rounded-lg border border-green-300 bg-green-100 p-3">
            ...
            @if($existingFace)
                @if($faceIncomplete)
                    <div class="mx-2 mb-3 rounded-lg bg-orange-100 border border-orange-300 p-3">
                ...
                @else
                    @switch($existingFace->status)
                        @case('pending')
                            <div class="mx-2 mb-3 rounded-lg bg-yellow-100 border border-yellow-300 p-3">
                        ...
                        @break
                        @case('approved')
                            <div class="mx-2 mb-3 rounded-lg bg-green-100 border border-green-300 p-3">
                        ...
                        @break
                        @case('rejected')
                            <div class="mx-2 mb-3 rounded-lg bg-red-100 border border-red-300 p-3">
